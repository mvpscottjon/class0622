...
class ViewController: UIViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    private let mydata = ["猜數字v1", "猜數字v2","切換場景","自訂view", "簽名板", "自訂cell的tableView","Item4","Item3","Item1", "Item2","Item4","Item3","Item1", "Item2","Item4","Item3"]
...
var UI = ViewController
 UI.tableView(<#T##tableView: UITableView##UITableView#>, cellForRowAt: <#T##IndexPath#>)
